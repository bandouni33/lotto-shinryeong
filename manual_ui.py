    ...
    return [
        {
            ...
            "notes": [
                ...
                "해석을 본 뒤에는 화면 아래 [자동구매로] · [번개조합으로] 버튼으로 "
        ...
        },
        {
            ...
            "steps": [
                "구매 수량을 고릅니다 (5개 / 10개)",
                "구매 확정을 누릅니다",
                "구매내역에서 배정된 번호를 확인합니다",
            ],
            "price": f"5개 조합 {auto_unit * 5:,}P · 10개 조합 {auto_unit * 10:,}P (1개당 {auto_unit:,}P)",
            "notes": [
                "배포 시간: 매주 화요일 09:00부터 토요일 19:55까지만 구매·배포됩니다. "
                "일·월요일 전체와 화요일 09:00 이전, 토요일 19:55 이후에는 구매할 수 없습니다.",
                "다음 회차 조합은 일요일 오후 2시대에 자동 생성됩니다. 생성이 끝나기 전에는 "
                "‘다음회차 조합생성이 완료된 후 이용’ 안내가 뜹니다.",
                "5개를 구매할 때마다 1~5위 그룹에서 각 1개씩 배정됩니다(10개면 각 2개씩).",
                "구매하면 자동 저장되고, 추첨 후 적중 여부가 자동으로 표시됩니다. "
                "구매·저장 내역은 최근 2회차까지만 보관됩니다.",
            ],
        },
        {
            "no": "03",
        ...
        },
        {
            "no": "04",
            "icon": "🛡️",
            "title": "구매복권 검증 (전체·개별리셋)",
            "badge": "배포 시간 제한 없음",
            "summary": "이미 산 로또 용지 번호를 넣으면, 그 번호와 반대 조건의 조합을 만들어 주는 방식",
            "steps": [
                "QR스캔(앱 카메라) 또는 직접입력으로 산 번호를 넣습니다",
                "만들 개수를 고릅니다",
                "조합시작을 누릅니다",
                "결과를 확인합니다 (자동 저장)",
            ],
